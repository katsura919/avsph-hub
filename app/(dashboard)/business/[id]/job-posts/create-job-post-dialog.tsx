...
export function CreateJobPostDialog({
    ...
    const { mutate: createJobPost, isPending: isCreating } =
        useCreateJobPost();
    const { mutate: updateJobPost, isPending: isUpdating } =
        useUpdateJobPost();
    ...
    useEffect(() => {
        if (editingJobPost) {
            setForm({
                ...
                requirementInput: "",
                requirements: editingJobPost.requirements || [],
                                ...
                                <div className="space-y-2">
                                    {form.stages.map((stage, index) => (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`w-2 h-2 rounded-full shrink-0 ${stage.type === "active"
                                                    ? "bg-blue-500"
                                                    : stage.type === "hired"
                                                        ? "bg-green-500"
                                                        : "bg-red-500"
